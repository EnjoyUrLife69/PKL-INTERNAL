                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="putih" name="nama"
                                                value="{{ $pendaftar->nama }}" disabled required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="jenisKelamin" class="col-sm-3 col-form-label">Jenis Kelamin</label>
                                        <div class="col-sm-9">
                                            <select class="form-control" id="jenisKelamin" name="jenis_kelamin" disabled
                                                value="{{ $pendaftar->jenis_kelamin }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="putih" name="kelas"
                                                disabled value="{{ $pendaftar->kelas }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="putih"
                                                name="asal_sekolah" disabled value="{{ $pendaftar->asal_sekolah }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="putih"
                                                name="nomor_telp_siswa" disabled
                                                value="{{ $pendaftar->nomor_telp_siswa }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="putih"
                                                name="nomor_telp_ortu" disabled
                                                value="{{ $pendaftar->nomor_telp_ortu }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="putih" name="email"
                                                disabled value="{{ $pendaftar->email }}" required>
                                        </div>
                                    </div>
